...
Refactored from: scripts/ai_config.py
"""
...
WRITER_SYSTEM_PROMPT = PROMPTS_DIR / "writer_system.md"
WRITER_TASK_PROMPT = PROMPTS_DIR / "writer_task.md"
REVIEWER_SYSTEM_PROMPT = PROMPTS_DIR / "reviewer_system.md"
...
def calculate_cost(model: str, input_tokens: int, output_tokens: int) -> float:
    ...
    if model not in PRICING:
        logger.warning(
            f"Model '{model}' not found in PRICING dict. Cost will be 0. "
...
# ============================================================================
# SYSTEM PROMPT (DEPRECATED - use prompts/writer_system.md)
# ============================================================================
...
# ============================================================================
# USER PROMPT TEMPLATE (DEPRECATED - use prompts/writer_task.md)
# ============================================================================
...
def get_user_prompt(
    ...
    return USER_PROMPT_TEMPLATE.format(
        ...
        certifications=(
            certifications if certifications not in ("Unknown", None, "") else ""
        ),
